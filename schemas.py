...
# Travel agency specific schema
class Inquiry(BaseModel):
    """
    Travel inquiries/leads from the website contact/booking form.
    Collection name: "inquiry"
    """
    name: str = Field(..., description="Visitor full name")
    email: EmailStr = Field(..., description="Visitor email")
    phone: Optional[str] = Field(None, description="Contact phone number")
    destination: Optional[str] = Field(None, description="Desired destination or package")
